...
def positional_encoding(
    ...
    Args:
      tensor (torch.Tensor): Input tensor to be positionally encoded. positional encodingされる入力テンソル
    ...
    """
    #print("@@@positional_encoding: x", tensor)
...
def main():
    ...
    def run_one_iter_of_tinynerf(height, width, focal_length, tform_cam2world,
      ...
      print("@@@flattened_query_points", flattened_query_points)
